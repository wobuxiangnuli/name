...
export default function (data, type = 'html', ui = 'element') {
  ...
  const cdnjs = ui == 'element' ? 'https://unpkg.com/element-plus' : 'https://unpkg.com/ant-design-vue@3.2.3/dist/antd.min.js'
  ...
  if (ui == 'element') {
    ...
    if (isDark) {
      cdncss = `<link rel="stylesheet" href="https://unpkg.com/ant-design-vue@3.2.3/dist/antd.dark.min.css">`
    } else {
      cdncss = `<link rel="stylesheet" href="https://unpkg.com/ant-design-vue@3.2.3/dist/antd.min.css">`
    }
  }
