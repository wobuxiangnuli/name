<template>
  ...
  <!-- 电话控件 -->
  <template v-if="element.type == 'phone' || element.type == 'landline'">
    <el-input-number
      v-model="element.options.defaultValue"
      :disabled="element.options.disabled"
      :controls="element.options.controls"
  ...
  <template v-if="element.type == 'checkbox'">
    <el-checkbox-group
      ...
      :style="{
        ...
        'flex-wrap': 'wrap',
        'flex-direction':
          element.options.inline == 'juzhen' || element.options.inline
            ? 'row'
            : 'column',
        'justify-content':
          element.options.inline == 'juzhen' ? 'space-between' : '',
      }"
      :disabled="element.options.disabled"
      v-bind="element.options.customProps"
    >
  ...
  <!-- 下拉菜单控件 -->
  <template v-if="element.type == 'select' || element.type == 'checkselect'">
    <el-select
      v-model="element.options.defaultValue"
      :disabled="element.options.disabled"
      :multiple="element.options.multiple"
  ...
  <!-- 附件控件 -->
  <template v-if="element.type == 'annex'">
    <el-upload
  ...
  <template v-if="element.type == 'custom'">
    <component
      ...
      :clearable="element.options.clearable"
      v-bind="{
        ...element.options.customProps,
        ...element.options.extendProps,
      }"
    ></component>
  </template>
  ...
  <template v-if="element.type == 'text'">
    <span
      :style="{
        width: isTable ? '100%' : element.options.width || '100%',
        display: 'inline-block',
      }"
  ...
  <template v-if="element.type == 'html'">
    <span
      ...
      v-html="element.options.defaultValue"
    ></span>
  </template>
  ...
  <template v-if="element.type == 'button'">
    <el-button
      ...
      :type="
        element.options.buttonType == 'text' ||
        element.options.buttonType == 'link'
          ? 'primary'
          : element.options.buttonType
      "
