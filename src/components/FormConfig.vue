  ...
  <el-scrollbar>
    <div class="form-config-container">
      <el-form label-position="top" size="default">
        ...
        <!-- 表单描述 -->
        <el-form-item :label="$t('fm.config.form.description')">
          <el-input type="textarea" rows="3" v-model="dataModel.description"   clearable></el-input>
        </el-form-item>
      </el-form>

      <code-dialog ref="styleDialog" mode="css" :title="$t('fm.config.form.styleSheets')"
        help="https://form.making.link/docs/manual/custom-style.html#%E8%A1%A8%E5%8D%95%E6%A0%B7%E5%BC%8F%E8%A1%A8"
        @on-confirm="handlestyleSheetsConfirm"></code-dialog>

      <datasource-dialog ref="dataSourceDialog" @dialog-close="handleDataSourceClose"></datasource-dialog>

      <event-script-dialog ref="eventScriptDialog" @dialog-close="handleEventScriptClose"
        @dialog-confirm="handleEventConfirm"></event-script-dialog>
    </div>
  </el-scrollbar>
</template>
