<template>
  <div class="fm-form-item" :data-id="widget.model" v-if="widget.key">
    ...
    <el-form-item v-if="widget.type == 'divider' && (isSubform || isTable ? display[widget.model] && !subHideFields[rowIndex][widget.model] : display[widget.model])" label-width="0">
      <el-divider 
    ...
    <el-form-item v-if="widget.type == 'alert' && (isSubform || isTable ? display[widget.model] && !subHideFields[rowIndex][widget.model] : display[widget.model])" label-width="0">
      <el-alert 
